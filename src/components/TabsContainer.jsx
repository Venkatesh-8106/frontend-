import { BarChart3, ClipboardCheck, FilePlus2 } from 'lucide-react'
import TabItem from './TabItem'

export default function TabsContainer({ view, setView, isAdmin }) {
  const tabs = isAdmin
    ? [{ id: 'admin', label: 'Overview', icon: BarChart3 }]
    : [{ id: 'new-request', label: 'New request', icon: FilePlus2 }, { id: 'requests', label: 'My requests', icon: ClipboardCheck }, { id: 'admin', label: 'Overview', icon: BarChart3 }]
