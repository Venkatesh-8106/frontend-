...
const initialForm = { name: '', email: '', password: '', role: 'Student', facultyId: '', rollNo: '', college: '', department: '', section: '' }
...
export default function RegisterForm({ onBack, onSuccess }) {
  ...
  async function handleSubmit(event) {
    ...
    if (form.role === 'Student' && !form.rollNo.trim()) return setError('Enter your Roll No before creating your account.')
